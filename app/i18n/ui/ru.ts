...
export const ui: UiDictionary = {
  ...
  library: {
    ...
    saved: "Сохранённые органы", emptySaved: "Пока нет сохранённых органов. Добавьте один из библиотеки.", notesHint: "Ваши заметки появятся здесь чипами.", viewAll: "Показать все органы",
  ...
  tools: {
    ...
    section: "Обрезка", layers: "Прозрачность", compare: "Сравнить", reset: "Сброс",
  },
  viewer: {
    ...
    loading: "Готовим: {organ}", loadError: "Не удалось загрузить: {organ}", autoRotate: "Автовращение",
